...
他にも、設定次第でAirshipでの**配線タスクの追加**や、Polusでの**マルチスポーンポイント**、各マップの**追加ベント**など\
...
| ---------- | ---------- | ---------- |
|23.01.09a | 2022.12.14 | [Download](https://github.com/huolangwangluo/Nebula/releases/download/23.01.09a/Nebula_v23.01.09a.zip)
...
| 日本語 | kihi | 1.13.3 | [Download](https://github.com/Dolly1016/Nebula/releases/download/LANG%2CJP%2C1.13.3%2Ckihi/Japanese.dat)|
...
| English | - | 1.13.1.2 | [Download](https://github.com/Dolly1016/Nebula/releases/download/1.13.1.1,2022.8.24/English.dat)|
 ...
 **Version 1.9.2.2**
 ...
 - 着せ替え画面で文字の大きさが変わってしまうときがあった問題を修正
 - プレイヤー色に準じるカスタムバイザーの、着せ替え画面内での表示が適切でない問題を修正
 ...
 **Version 1.6.4**
 - 新ハンター「Hadar」を追加
 - カスタムサーバーを使用可能に
 - 新たな配線タスクをクリックしたとき、クリック操作が効かなくなる問題を修正
  
 **Version 1.6.3.4**
 - タイトル画面の構成を変更
 - Agent, Opportunistが正常に動作しない問題を修正
...
## Hadar
 Hadarは、地中から湧き出ることで周囲の逃走者に恐怖を植え付けます。\
 恐怖が最大まで高まった逃走者は死に至ります。
...
| オプション名 | 設定内容 |
|----------|:-------------:|
| Damage Radius | ダメージ範囲
| Damage Level | ダメージ強度
| Reappear Cool Down | 隠遁から再出現までの最低間隔
